...
def get_db_data():
    try:
        ...
        # Aplicar reescalado específico por raspberry_id
        if 'raspberry_id' in df.columns:
            # Definir factores de reescalado por raspberry_id
            scaling_factors = {
                3: 1.32,
                4: 1.2,
                7: 1.2
            ...
            # Aplicar reescalado para cada raspberry_id
            for raspberry_id, factor in scaling_factors.items():
                mask = df['raspberry_id'] == raspberry_id
